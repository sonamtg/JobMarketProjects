* 4. Estimate a double fixed effect model with individual and firm fixed effects with controls year dummies, age and age squared
...
* 5. Save the estimated fixed effects
